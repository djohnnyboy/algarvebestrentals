                ...
                <div class="col-sm-12 col-md-6 col-lg-4 boxes">
                    <div class="card border shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex bd-highlight">
                                <div class="flex-fill bd-highlight" style="height:100px;width:100%;background-color: #F5F5F5;">     
                                    ...
                                    @csrf
                                        ...
                                        <p class="text-center legendasIcons" style="margin-bottom:-0.1px;font-weight:bold;">Price €{{ ($epBaixa * $carro->epocaBaixa) + ($epMedia * $carro->epocaMedia) + ($epMediaAlta * $carro->epocaMediaAlta) + ($epAlta * $carro->epocaAlta) }}</p>
                                        ...
                                        <input type="hidden" value="{{ ($epBaixa * $carro->epocaBaixa) + ($epMedia * $carro->epocaMedia) + ($epMediaAlta * $carro->epocaMediaAlta) + ($epAlta * $carro->epocaAlta) }}" name="precoBasic">
                                ...
                                <div class="flex-fill bd-highlight" style="height:100px;width:100%;background-color:#E0E0E0;">
                                    ...
                                    @csrf
                                        ...
                                        <p class="text-center legendasIcons" style="margin-bottom:-0.1px;">Price €{{ (($epBaixa * $carro->seguro) + $epBaixa * $carro->epocaBaixa) + (($epMedia * $carro->seguro) + $epMedia * $carro->epocaMedia) + (($epMediaAlta * $carro->seguro) + $epMediaAlta * $carro->epocaMediaAlta) + (($epAlta * $carro->seguro) + $epAlta * $carro->epocaAlta) }}</p>
                                        <input type="submit" value="Book Now >" class="allIncButton" />
                                        <input type="hidden" value="{{$quote}}" name="quoteId">
                                        <input type="hidden" value="{{$carro->id}}" name="carId"> 
                                        <input type="hidden" value="{{ (($epBaixa * $carro->seguro) + $epBaixa * $carro->epocaBaixa) + (($epMedia * $carro->seguro) + $epMedia * $carro->epocaMedia) + (($epMediaAlta * $carro->seguro) + $epMediaAlta * $carro->epocaMediaAlta) + (($epAlta * $carro->seguro) + $epAlta * $carro->epocaAlta) }}" name="precoAllInc">
