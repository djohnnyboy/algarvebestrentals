            ...
            <div class="card border shadow-lg">
                ...
                <form method="post" action="{{ route('blog.store') }}" enctype="multipart/form-data">            
                    ...
                    <div class="text-center">s
                        <p class="text-white">Cuidado !!! Isto vai criar um post novo no teu sistema.</p>
                        <input type="submit" class="btn btn-primary btn-lg" role="button" value="Criar um post novo" style="width:100%;">
                    </div>         
                </form>
            </div>
            </div>
